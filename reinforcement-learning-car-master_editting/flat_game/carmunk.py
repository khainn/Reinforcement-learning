...
class GameState:
    ...
    #    We'll create three and they'll move around to prevent over-fitting.
        ...
        self.obstacles.append(self.create_obstacle(600, 620, 35))
        # self.obstacles.append(self.create_obstacle(445, 350, 70))
        # self.obstacles.append(self.create_obstacle(350, 500, 50))
        # self.obstacles.append(self.create_obstacle(850, 580, 60))
    ...
    def frame_step(self, action):
        ...
        vector_goal = Vec2d(goal_x - x,goal_y - y)
        ...
        # if x < 11:
        #     last_reward = -5 # too close to edges of the wall reward
        # if x > width - 11:
        #     last_reward = -5 #
        # if y < 11:
        #     last_reward = -5 #
