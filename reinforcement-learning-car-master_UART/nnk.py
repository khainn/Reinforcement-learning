...
while True:
    ...
    # senser1 = int(senser[1])
    # senser2 = int(senser[2])
    # senser3 = int(senser[3])

    # readings.append(senser1)
    # readings.append(senser2)
    # readings.append(senser3)
...
#         driving_direction_1 = Vec2d(-20, 0).rotated(car_body_angle)
