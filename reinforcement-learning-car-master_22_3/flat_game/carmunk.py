...
class GameState:
    ...
    #    We'll create three and they'll move around to prevent over-fitting.
        ...
        self.obstacles.append(self.create_obstacle(600, 600, 40))
        # self.obstacles.append(self.create_obstacle(100, 400, 25))
        # self.obstacles.append(self.create_obstacle(300, 550, 50))
        # self.obstacles.append(self.create_obstacle(400, 350, 30))
    ...
    def frame_step(self, action):
        ...
        orientate_goal = Vec2d(goal_x, goal_y)
        orientate_car = Vec2d(1, 0).rotated(self.car_body.angle)
